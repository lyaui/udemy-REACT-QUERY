  ...
  return (
    <>
      ...
      <div>
        ...
        {updatePostMutation.isPending && <p className='loading'>Loading</p>}
        {updatePostMutation.isSuccess && <p className='success'>Success</p>}
        {updatePostMutation.isError && <p className='error'> Error</p>}
      </div>
      <p>{post.body}</p>
      <h4>Comments</h4>
      {data.map((comment) => (
